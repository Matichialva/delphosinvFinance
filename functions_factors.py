...
def add_factors_to_topdown(topDownFactorsDF, factorsDF, pricesDF, percentageDF):
    ...
    for factor in factors:
        ...
        for time in time_frames:
            ...
            topDownFactorsDF.loc[(factor, "30% top"), time] = round(top_returns_mean, 1)  #añado al dataframe
            ...
            topDownFactorsDF.loc[(factor, "30% bottom"), time] = round(bottom_returns_mean, 1) # añado al dataframe
