...
def style_dataframe(percentageDF):
    '''applyies gradient to the columns i picked'''
    columnsExcluded = ["Stock", "Sector"]
    columnsIncluded = percentageDF.columns.difference(columnsExcluded)
    stylePercentageDF = percentageDF.style.background_gradient(subset=columnsIncluded, cmap='RdYlGn',
